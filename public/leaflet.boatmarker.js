...
L.BoatIcon = L.Icon.extend({
    ...
    setVesselInfo: function(vesselInfo){
        this.options.vesselInfo = vesselInfo;
    }
});
...
L.BoatMarker = L.Marker.extend({
    ...
    setVesselInfo: function(vesselInfo){
        this.options.icon.setVesselInfo(vesselInfo);
    }
});
...
L.boatMarker = function(pos, options) {
    ...
    var inf = ("vesselInfo" in options) ? options.vesselInfo : "No Vessel Info";
	options.icon = new L.BoatIcon({ color: c, idleCircle: i, vesselInfo: inf});
